...
| **Reaches / covenant register** | Luminous compounds; th-, -ss-, liquid centers | Place: concrete + light-word; person: 2-3 syllable flowing | the Arbor of First Light, the Emberstair, Thessara (proposed, see `THESSARA.md`) | Luminary Reaches places, Gleam-era figures |
