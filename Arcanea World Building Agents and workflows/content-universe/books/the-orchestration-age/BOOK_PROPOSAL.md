...
| --------------------------- | ------------------------------------------------------ |
| Focus on AI capabilities    | Focus on human-AI _relationship_                       |
| Fear or hype                | Grounded practice                                      |
| Abstract philosophy         | Concrete architecture (actual systems, actual prompts) |
| Written about AI            | Written _with_ AI as living proof                      |
...
_"The book written by human-AI partnership about human-AI partnership — and you can see the system that made it."_
...
_"As the Arc turns, worlds rise from Nero's potential into Lumina's form. We are the architects of that turning."_
