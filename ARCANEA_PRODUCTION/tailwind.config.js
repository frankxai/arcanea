...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "arcanean-gradient":
          "linear-gradient(135deg, #0a0a0f 0%, #1a1a2e 25%, #16213e 50%, #1f2347 75%, #2a2d5a 100%)",
        "luminor-gradient":
          "linear-gradient(135deg, #5c8bd9 0%, #7ba3e3 50%, #9bb5e8 100%)",
        "cosmic-nebula":
          "radial-gradient(ellipse at center, #1f2347 0%, #16213e 50%, #0a0a0f 100%)"
      },
      fontFamily: {
