...
export const GUARDIAN_MEDIA = {
  draconia: {
    // To upload: C:\Users\frank\arcanea-processed\Draconia\ (128 files)
    heroImage: "",
  ...
  alera: {
    // To upload: C:\Users\frank\arcanea-processed\Alera\ (68 files)
    heroImage: "",
    thumbnails: [] as string[],
  ...
  elara: {
    // To upload: C:\Users\frank\arcanea-processed\Elara\ (37 files)
    heroImage: "",
    thumbnails: [] as string[],
  ...
  ino: {
    // To upload: C:\Users\frank\arcanea-processed\Ino\ (8 files)
    heroImage: "",
    thumbnails: [] as string[],
  ...
  aiyami: {
    // To upload: C:\Users\frank\arcanea-processed\Aiyami\ (3 files)
    heroImage: "",
    thumbnails: [] as string[],
  ...
  lyssandria: {
    // To upload: C:\Users\frank\arcanea-processed\Lyssandria\ (2 files)
    heroImage: "",
    thumbnails: [] as string[],
